...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/carmonasl/interchange/dex/buy_order_book
   */
  queryBuyOrderBookAll = (
    ...
    this.request<DexQueryAllBuyOrderBookResponse, RpcStatus>({
      path: `/carmonasl/interchange/dex/buy_order_book`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/carmonasl/interchange/dex/buy_order_book/{index}
   */
  queryBuyOrderBook = (index: string, params: RequestParams = {}) =>
    this.request<DexQueryGetBuyOrderBookResponse, RpcStatus>({
      path: `/carmonasl/interchange/dex/buy_order_book/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/carmonasl/interchange/dex/denom_trace
   */
  queryDenomTraceAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<DexQueryAllDenomTraceResponse, RpcStatus>({
      path: `/carmonasl/interchange/dex/denom_trace`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/carmonasl/interchange/dex/denom_trace/{index}
   */
  queryDenomTrace = (index: string, params: RequestParams = {}) =>
    this.request<DexQueryGetDenomTraceResponse, RpcStatus>({
      path: `/carmonasl/interchange/dex/denom_trace/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/carmonasl/interchange/dex/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<DexQueryParamsResponse, RpcStatus>({
      path: `/carmonasl/interchange/dex/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/carmonasl/interchange/dex/sell_order_book
   */
  querySellOrderBookAll = (
    ...
    this.request<DexQueryAllSellOrderBookResponse, RpcStatus>({
      path: `/carmonasl/interchange/dex/sell_order_book`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/carmonasl/interchange/dex/sell_order_book/{index}
   */
  querySellOrderBook = (index: string, params: RequestParams = {}) =>
    this.request<DexQueryGetSellOrderBookResponse, RpcStatus>({
      path: `/carmonasl/interchange/dex/sell_order_book/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
