...
import CarmonaslInterchangeCarmonaslInterchangeDex from './carmonasl/interchange/carmonasl.interchange.dex'
...
export default { 
  CarmonaslInterchangeCarmonaslInterchangeDex: load(CarmonaslInterchangeCarmonaslInterchangeDex, 'carmonasl.interchange.dex'),
